    ...
    <div className="flex h-screen " style={{ fontFamily: 'Poppins, sans-serif' }}>       
      ...
      >
        <button           
          ...
          className="absolute top-4 right-[-28px] text-[rgb(255,255,255)] transform translate-x-1/2 bg-gray-700 border-2 border-gray-300 p-2 rounded-full z-10 hover:bg-gray-600 transition duration-300 hover:scale-105"         
        >           
