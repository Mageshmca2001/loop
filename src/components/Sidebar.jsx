    ...
    <div className="flex h-screen" style={{ fontFamily: 'Poppins, sans-serif' }}>       
      ...
      >
        <button           
          ...
          className="absolute top-4 right-[-35px] z-10 text-[rgb(255,255,255)] transform translate-x-1/2 bg-blue-500 border-2 border-gray-300 p-2 rounded-full hover:bg-blue-800 transition duration-300 hover:scale-105"         
        >           
