...
const Dashboard = () => {
 ...
 <div className="flex">
     ...
     <div className="flex-1 bg-white min-h-screen" style={{ fontFamily: 'Poppins, sans-serif' }}>
  <header className="bg-blue-800 p-3  shadow-md flex flex-wrap justify-between items-center">
    ...
    <div className="flex items-center space-x-4">
      ...
      <button
        className="p-3 bg-red-500 rounded-full text-white hover:bg-red-600 focus:outline-none flex items-center space-x-1"
  ...
  <main className=" max-7xl p-4  grid grid-cols-1 gap-4 mt-4 lg:grid-cols-2 lg:grid-cols-4">
    {[
